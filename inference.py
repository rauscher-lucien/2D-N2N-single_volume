...
def main():
    ...
    project_dir = r"C:\Users\rausc\Documents\EMBL\final_projects\2D-N2N-single_volume\Nema_B-test_x"
    ...
    filename = f'output_stack-{project_name}-{inference_name}-epoch{epoch}-{hyperparameters_str}.TIFF'
